...
const recipeResult = document.getElementById("featuredResult");
fetch(
  "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random?tags=veryHealthy%2Cdinner&number=3",
  options
)
